...
public class LunarSolar
{
	...
	public static void main(String[] args)
	{
		...
		//找到 2101年前自己所有的农历生日  对应的阳历日期
		
		
		final int LUNAR_MONTH=6;//农历月
		final int LUNAR_DAY=30;//农历日
		int a=0;
		...
		for(int i=0;i<30000;i++)
		{
			...
			solar.solarYear=instance.get(Calendar.YEAR);
			solar.solarMonth=instance.get(Calendar.MONTH) + 1;
			solar.solarDay=instance.get(Calendar.DAY_OF_MONTH);
			
			Lunar lunar=SolarToLunar(solar);
			
			
			if(lunar.lunarMonth==LUNAR_MONTH && lunar.lunarDay==LUNAR_DAY)
			{
				System.out.println(++a + "\t" + solar.solarYear + "年" + solar.solarMonth + "月" + solar.solarDay + "日");
			}
